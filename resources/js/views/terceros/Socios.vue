  ...
  <div class="p-6" :class="isDark ? 'bg-gray-900 min-h-screen' : 'bg-gray-50 min-h-screen'">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <div class="flex items-center mt-1">
            <span class="text-sm text-gray-500">Gestión de socios comerciales y alianzas estratégicas</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
      ...
      <div class="bg-white rounded-lg border p-4" :class="isDark ? 'bg-gray-800 border-gray-700' : 'border-gray-200'">
        ...
        <div class="text-sm text-gray-500">Total Socios</div>
      </div>
    ...
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center space-x-4">
        ...
        <button class="text-gray-500 hover:text-gray-700" @click="loadPartners">
        ...
        <table class="min-w-full">
          ...
          <tbody class="bg-white divide-y divide-gray-200" :class="isDark ? 'bg-gray-800 divide-gray-700' : ''">
            ...
            <tr v-else v-for="partner in paginatedPartners" :key="partner.id" class="hover:bg-gray-50 transition-colors" :class="isDark ? 'hover:bg-gray-700' : ''">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <div class="text-sm text-gray-500">{{ partner.code_client || 'Sin código' }}</div>
                  </div>
                </div>
              </td>
              ...
              <!-- Email -->
              <td class="px-6 py-4 whitespace-nowrap text-sm" :class="isDark ? 'text-gray-300' : 'text-gray-900'">
                <a v-if="partner.email" :href="`mailto:${partner.email}`" class="text-blue-600 hover:text-blue-800">
                  {{ partner.email }}
                </a>
                <span v-else>-</span>
              </td>
